...
namespace OpenAI
{
    public class PracticeStoryControllerFantasy : MonoBehaviour
    {
        ...
        public void EnterPractice(int num){
            ...
            var practiceStoryMessage = new List<ChatMessage>
            {
                ...
                {
                    Role = "user",
                    Content = "請以第一人稱視角生成一小段修練奇幻技能一天的劇情"
                }
            };
        ...
        private void MoveOn(){
            if(canMove){
                ...
                if(textBoxCount != 0 && textBoxCount >= currentFullTexts.Length){
                    ...
                    GameObject.Find("StoryController").GetComponent<GrowthSystemControllerFantasy>().GetForceValue();
